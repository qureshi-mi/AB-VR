...
A = Weight_matrix(UG).row_stochastic()
...
# Uncomment the following to run the other algorithms
# ## AB-SAGA     
# theta_ABSAGA = dopt.AB_SAGA(lr_0,A,B,step_size,int( depoch*b),theta_0)  
# res_F_ABSAGA = error_lr_0.cost_gap_path( np.sum(theta_ABSAGA,axis = 1)/n)
# ## PushSVRG     
# theta_PushSVRG = dopt.Push_SVRG(lr_0,B,B,step_size,int( depoch*b),theta_0)  
# res_F_PushSVRG = error_lr_0.cost_gap_path( np.sum(theta_PushSVRG,axis = 1)/n)
# ## AB-SVRG     
# theta_ABSVRG = dopt.AB_SVRG(lr_0,A,B,step_size,int( depoch*b),theta_0)  
# res_F_ABSVRG = error_lr_0.cost_gap_path( np.sum(theta_ABSVRG,axis = 1)/n)
